...
# training stage 2 
  ...
  # for cue set 1 + HF cue set 2 for Acc outcome:
  ...
  options1d
  # for cue set 1 + HF cue set 2 for Prep outcome:
  ...
  # for cue set 1 + LF cue set 2 for Acc outcome:
  ...
  options3d
  # for cue set 1 + LF cue set 2 for Prep outcome:
...
# save the mean for cue sets, with outcome type combined (for the barplot)
...
# data frame for barplot for 400 trials compared to asymptote model:
