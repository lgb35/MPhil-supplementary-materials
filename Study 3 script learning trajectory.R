# Study 3 script learning trajectory
...
# plot for learned weights to Acc outcome.
...
# plot for learned weights to Prep outcome:
...
options8
# save correct choice probability for each outcome:
...
# data frame for barplot with both 4000- and 400-trial models:
